package com.dayorolands.run.network

import com.dayorolands.core.data.networking.constructRoute
import com.dayorolands.core.data.networking.delete
import com.dayorolands.core.data.networking.get
import com.dayorolands.core.data.networking.safeCall
...
import com.dayorolands.core.domain.util.map
import com.dayorolands.run.network.mappers.toCreateRunRequest
import com.dayorolands.run.network.mappers.toRun
            ...
            httpClient.submitFormWithBinaryData(
                ...
                formData = formData {
                    append("MAP_PICTURE", mapPicture, Headers.build {
                        ...
                        append(HttpHeaders.ContentDisposition, "filename=mappicture.jgp")
                    })
